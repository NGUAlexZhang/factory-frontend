<template>
    <div>
      ...
      <el-input v-model="id" style="width:20%" placeholder="id"></el-input>
        ...
        <staff-table :id="id" :name="name" :by="by" :order="order" :size="size" :page="page" :key="key"
                        @update="update" @changePage="changePage"></staff-table>
        <el-dialog title="新增客户" :visible.sync="add">
            <el-form>
                ...
                <el-form-item>
                    <el-input v-model="attend" placeholder="出勤率"></el-input>
                </el-form-item>
                <el-form-item>
...
<script>
import staffTable from "@/views/staff/staff-table";
...
export default {
    ...
    methods: {
        async submit() {
            ...
            try {
                await addStaff(this.addName, this.date, this.sex,this.attend)
                this.add = false
                this.key = !this.key
            } catch (e) {
                console.log(e)
